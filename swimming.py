...
# Gallant swims for 0 minutes, and Goofus swims for 1 min
# Gallant does check the water first
# So does Goofus
# The first while statement ends on its own without a break, since the condition to continue is if the temperature hits or drops below the minumum temperature. 
# The break in the second loop is to manually signal when the loop should end, since it is not written in the while condition when it should end
# First is called a pre-test, and the second is called a post-test
